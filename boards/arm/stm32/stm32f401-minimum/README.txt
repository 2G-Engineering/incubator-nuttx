...
NucleoF401CD from ST Micro.  See
...
The NucleoF411CD also has additional DMA and SPI peripheral capabilities.
...
Board features, however, are identical:
  ...
  See http://mbed.org/platforms/ST-Nucleo-F401CD for more
...
================================
  ...
  1. You must have already configured Nuttx in <some-dir>/nuttx.
     ...
     $ (cd tools; ./configure.sh stm32f401-minimum/f401-nsh)
     $ make qconfig
...
====
  ...
  The Nucleo-F401CD includes boot loader from mbed:

    https://mbed.org/platforms/ST-Nucleo-F401CD/
    https://mbed.org/handbook/Homepage

  Using the mbed loader:

  1. Connect the stm32f401-minimum to the host PC using the USB connector.
  2. A new file system will appear called NUCLEO; open it with Windows
     Explorer (assuming that you are using Windows).
  3. Drag and drop nuttx.bin into the MBED window.  This will load the
     nuttx.bin binary into the stm32f401-minimum.  The NUCLEO window will
     close then re-open and the stm32f401-minimum will be running the new code.
...
========
  ...
  From: https://mbed.org/platforms/ST-Nucleo-F401CD/
  ...
  LEDs
  ----
  The Nucleo F401CD and provide a single user LED, LD2.  LD2
...
=======
  ...
  Supports a single RS-232 connected via
    ...
    Nucleo CN9  STM32F4x1CD  Cutedigi
    ----------- ------------ --------
  ...
  Itead Joystick Connection:
    ...
    USART or select CONFIG_NUCLEO_F401CD_AJOY_MINBUTTONS which will
  ...
  2014-12-04:
    ...
    - There is conflicts with some of the Arduino data pins and the
      ...
      but with CONFIG_NUCLEO_F401CD_AJOY_MINBUTTONS to eliminate the
      conflict.
...
==============
  ...
  ---------
    ...
    Nucleo-F401CD board.  The Configuration enables the serial interfaces
