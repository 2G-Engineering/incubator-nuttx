/****************************************************************************
 * arch/arm/src/stm32h7/stm32_foc.c
 *
...
#if defined(CONFIG_STM32H7_FOC_ADC_CCR4)
#  if CONFIG_MOTOR_FOC_PHASES > 3
#    error max 3 phases supported
#  endif
#elif defined(CONFIG_STM32H7_FOC_ADC_TRGO)
...
#if defined(CONFIG_STM32H7_FOC_ADC_CCR4) && defined(CONFIG_STM32H7_FOC_ADC_TRGO)
...
#ifdef CONFIG_STM32H7_FOC_USE_TIM1
#  define ADC_JEXTSEL_T1CC4  (ADC_CR2_JEXTSEL_T1CC4)
#endif
#ifdef CONFIG_STM32H7_FOC_USE_TIM8
...
#  ifndef CONFIG_STM32H7_PWM_TRGO
...
#ifdef CONFIG_STM32H7_FOC_USE_TIM1
#  define ADC_JEXTSEL_T1TRGO  (ADC_JSQR_JEXTSEL_T1TRGO)
#endif
#ifdef CONFIG_STM32H7_FOC_USE_TIM8
...
#ifdef CONFIG_STM32H7_FOC_FOC0
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC1
#    define FOC0_ADC 1
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC2
#    define FOC0_ADC 2
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC3
#    define FOC0_ADC 3
#  endif
#endif
...
#ifdef CONFIG_STM32H7_FOC_FOC1
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC1
#    define FOC1_ADC 1
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC2
#    define FOC1_ADC 2
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC3
#    define FOC1_ADC 3
#  endif
#endif
...
#ifdef CONFIG_STM32H7_FOC_USE_ADC1
...
#  endif
#  if CONFIG_STM32H7_ADC1_ANIOC_TRIGGER != 1
#    error CONFIG_STM32H7_ADC1_ANIOC_TRIGGER must be 1
#  endif
#  if CONFIG_STM32H7_ADC1_INJECTED_CHAN != FOC_ADC_INJ_CHAN_REQUIRED
#    error Invalid configuration for ADC1 injected channels
#  endif
#endif
#ifdef CONFIG_STM32H7_FOC_USE_ADC2
#  ifndef CONFIG_STM32H7_ADC2
#    error ADC2 not supported !
#  endif
#  ifndef ADC2_HAVE_JEXTCFG
#    error ADC2 must support JEXTCFG
#  endif
#  if CONFIG_STM32H7_ADC2_ANIOC_TRIGGER != 1
#    error CONFIG_STM32H7_ADC2_ANIOC_TRIGGER must be 1
#  endif
#  if CONFIG_STM32H7_ADC2_INJECTED_CHAN != FOC_ADC_INJ_CHAN_REQUIRED
#    error Invalid configuration for ADC2 injected channels
#  endif
#endif
#ifdef CONFIG_STM32H7_FOC_USE_ADC3
#  ifndef CONFIG_STM32H7_ADC3
#    error ADC3 not supported !
#  endif
#  ifndef ADC3_HAVE_JEXTCFG
#    error ADC3 must support JEXTCFG
#  endif
#  if CONFIG_STM32H7_ADC3_ANIOC_TRIGGER != 1
#    error CONFIG_STM32H7_ADC3_ANIOC_TRIGGER must be 1
#  endif
#  if CONFIG_STM32H7_ADC3_INJECTED_CHAN != FOC_ADC_INJ_CHAN_REQUIRED
...
#ifdef CONFIG_STM32H7_FOC_FOC0
#  define FOC0_ADC_JEXT (ADC_JSQR_JEXTEN_RISING | FOC0_ADC_JEXTSEL)
#endif
#ifdef CONFIG_STM32H7_FOC_FOC1
#  define FOC1_ADC_JEXT (ADC_JSQR_JEXTEN_RISING | FOC1_ADC_JEXTSEL)
#endif
...
#define STM32H7_IRQ_ADC1_FOC  STM32_IRQ_ADC12
#define STM32H7_IRQ_ADC2_FOC  STM32_IRQ_ADC12
#define STM32H7_IRQ_ADC3_FOC  STM32_IRQ_ADC3
...
#ifdef CONFIG_STM32H7_FOC_FOC0
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC1
#    define FOC0_ADC_IRQ STM32H7_IRQ_ADC1_FOC
#    define FOC0_ADC_CMN FOC_ADC1_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC2
#    define FOC0_ADC_IRQ STM32H7_IRQ_ADC2_FOC
#    define FOC0_ADC_CMN FOC_ADC2_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC3
#    define FOC0_ADC_IRQ STM32H7_IRQ_ADC3_FOC
#    define FOC0_ADC_CMN FOC_ADC3_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC0_ADC4
#    define FOC0_ADC_IRQ STM32H7_IRQ_ADC4_FOC
...
#ifdef CONFIG_STM32H7_FOC_FOC1
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC1
#    define FOC1_ADC_IRQ STM32H7_IRQ_ADC1_FOC
#    define FOC1_ADC_CMN FOC_ADC1_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC2
#    define FOC1_ADC_IRQ STM32H7_IRQ_ADC2_FOC
#    define FOC1_ADC_CMN FOC_ADC2_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC3
#    define FOC1_ADC_IRQ STM32H7_IRQ_ADC3_FOC
#    define FOC1_ADC_CMN FOC_ADC3_CMN
#  endif
#  ifdef CONFIG_STM32H7_FOC_FOC1_ADC4
#    define FOC1_ADC_IRQ STM32H7_IRQ_ADC4_FOC
...
#ifdef CONFIG_STM32H7_FOC_HAS_PWM_COMPLEMENTARY
...
#if defined(CONFIG_STM32H7_FOC_ADC_CCR4) || (CONFIG_MOTOR_FOC_PHASES > 3)
...
#define PWM_MODE_HSLO_LSHI STM32_CHANMODE_OCREFLO
#define PWM_MODE_HSHI_LSLO STM32_CHANMODE_OCREFHI
...
struct stm32_foc_data_s
{
  ...
  int32_t       curr_offset[CONFIG_MOTOR_FOC_SHUNTS]; /* ADC current offset */
  int32_t       curr_raw[CONFIG_MOTOR_FOC_SHUNTS];    /* ADC current RAW */
#ifdef CONFIG_MOTOR_FOC_BEMF_SENSE
...
static void stm32_foc_curr_get(struct foc_dev_s *dev,
                               int32_t *curr, int shunts);
#ifdef CONFIG_MOTOR_FOC_BEMF_SENSE
static void stm32_foc_volt_get(struct foc_dev_s *dev, int32_t *volt);
#endif
  ...
  for (i = 0; i < CONFIG_MOTOR_FOC_INST; i += 1)
    {
      ...
      egr_reg[i] = foc_dev->pwm_base + STM32H7_GTIM_EGR_OFFSET;
    }
...
static int stm32_foc_pwm_cfg(struct foc_dev_s *dev, uint32_t freq)
{
  ...
  ret = PWM_DT_UPDATE(pwm, board->data->pwm_dt_ns);
  if (ret < 0)
    {
      goto errout;
    }
...
#if (CONFIG_MOTOR_FOC_INST > 1)
#  if defined(CONFIG_STM32H7_FOC_ADC_TRGO)
...
static int stm32_foc_setup(struct foc_dev_s *dev)
{
  ...
  ret = up_prioritize_irq(foc_dev->adc_irq, NVIC_SYSH_PRIORITY_MAX);
      ...
      for (i = 0; i < CONFIG_MOTOR_FOC_SHUNTS; i += 1)
        {
         ...
         mtrinfo("%d, %d\n", priv->data.curr_raw[0], priv->data.curr_raw[1]);
    }
  ...
  for (i = 0; i < CONFIG_MOTOR_FOC_SHUNTS; i += 1)
    {
      ...
      mtrinfo("ADC offset for channel %d = %"PRIi32"\n", i, priv->data.curr_offset[i]);
      if (priv->data.curr_offset >= 0) {
        /* Write offset */
...
static int stm32_foc_pwm_off(struct foc_dev_s *dev, bool off)
{
  ...
  if (off)
    {
      /* Disable complementary outputs BEFORE changing PWM modes */
  ...
  else
    {
      ...
      PWM_MODE_UPDATE(pwm, STM32_PWM_CHAN4, PWM_MODE_FOC);
#endif
      /* Only enable outputs AFTER PWM has been configured */
  ...
  for (i = 0; i < shunts; i += 1)
    {
       ...
       * NOTE: ADC value is up to 16 bits + sign.
       */

      curr[i] = (int32_t)STM32_ADC_INJDATA_GET(adc, i);
    }
}
...
struct adc_dev_s *stm32_foc_adc_init(struct stm32_foc_adc_s *adc_cfg)
{
  ...
  adc_dev = stm32h7_adc_initialize(adc_cfg->intf,
                                 adc_cfg->chan,
                                 adc_cfg->nchan);
...
stm32_foc_initialize(int inst, struct stm32_foc_board_s *board)
{
  ...
  modifyreg32(FOC_PWM_FZ_REG, 0, pwmfzbit); //set pwmfzbit to disable timer when halted
//  modifyreg32(FOC_PWM_FZ_REG, pwmfzbit, 0); //clear bit to enable timer when halted
