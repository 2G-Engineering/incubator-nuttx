/****************************************************************************
 * arch/arm/src/stm32h7/stm32_foc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H7_STM32_FOC_H
#define __ARCH_ARM_SRC_STM32H7_STM32_FOC_H
...
struct stm32_foc_board_ops_s
{
  ...
  int (*current_get)(struct foc_dev_s *dev, int32_t *curr_raw,
                     foc_current_t *curr);

#ifdef CONFIG_MOTOR_FOC_BEMF_SENSE
  /* Get BEMF voltage */

  int (*voltage_get)(struct foc_dev_s *dev, int32_t *volt_raw,
                     foc_voltage_t *volt);
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_STM32H7_STM32_FOC_H */
