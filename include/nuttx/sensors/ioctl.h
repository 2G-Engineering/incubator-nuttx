...
#define SNIOC_SET_INTEG_TIME       _SNIOC(0x0096)  /* Arg: LTR303ALS_ALS_INT_TIME_xxx */

#define SNIOC_SET_MEAS_RATE        _SNIOC(0x0097)  /* Arg: LTR303ALS_ALS_MEAS_RATE_xxx */

#define SNIOC_CONFIGURE_INT        _SNIOC(0x0098)  /* Arg: struct ltr303als_int_cfg_s* */
